  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white font-mono flex flex-col items-center justify-center p-6 selection:bg-[#D90429] selection:text-white">
      ...
      <div className="w-full max-w-2xl mb-12 text-center border-b border-white/10 pb-8">
        <h1 className="text-4xl md:text-5xl font-bold tracking-tighter mb-2">PROJETO VERTEX</h1>
        <p className="text-gray-500 text-xs tracking-[0.3em] uppercase">Acesso Autorizado // Nível 4</p>
      </div>
        ...
        <Link href="/morgana" className="group relative block bg-[#0a0a0a] border border-white/10 p-6 hover:border-[#D4AF37] transition-all duration-300 hover:bg-[#D4AF37]/5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold group-hover:text-[#D4AF37] transition-colors">PROTOCOLO: M.L.B.</h3>
                <p className="text-xs text-gray-600 uppercase tracking-wider">Parceria Estratégica // Acesso</p>
              </div>
            </div>
        ...
        <Link href="/fg" className="group relative block bg-[#0a0a0a] border border-white/10 p-6 hover:border-[#D90429] transition-all duration-300 hover:bg-[#D90429]/5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold group-hover:text-[#D90429] transition-colors">PROTOCOLO: BOARDROOM</h3>
                <p className="text-xs text-gray-600 uppercase tracking-wider">FG Empreendimentos // Financeiro</p>
              </div>
            </div>
        ...
        <Link href="/investor" className="group relative block bg-[#0a0a0a] border border-white/10 p-6 hover:border-[#FFD700] transition-all duration-300 hover:bg-[#FFD700]/5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold group-hover:text-[#FFD700] transition-colors">PROTOCOLO: ASCENSÃO</h3>
                <p className="text-xs text-gray-600 uppercase tracking-wider">Family Office Privado // Apresentação</p>
              </div>
            </div>
